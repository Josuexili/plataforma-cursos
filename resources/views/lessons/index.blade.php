    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Panell administratiu per a la gestio de lliçons.</p>
            </div>
            <a href="{{ route('lessons.create') }}" class="inline-flex rounded-md bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-700">
                Nova lliço
            </a>
        </div>
    </x-slot>
                        ...
                        @forelse ($lessons as $lesson)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right">
                                    @if (! $lesson->trashed())
                                        <a href="{{ route('lessons.show', $lesson) }}" class="text-gray-700 hover:text-gray-900">Veure</a>
                                        <span class="mx-2 text-gray-300">|</span>
                                        <a href="{{ route('lessons.edit', $lesson) }}" class="text-gray-700 hover:text-gray-900">Editar</a>
                                        <span class="mx-2 text-gray-300">|</span>
